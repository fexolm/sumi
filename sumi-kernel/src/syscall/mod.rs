...
pub extern "C" fn syscall_dispatch(args: &SyscallArgs) -> SyscallResult {
    let ret = match args.nr {
        ...
        258 => handlers::fs::sys_mkdirat(args),
        ...
        100 => handlers::time::sys_times(args),
        ...
        140 => handlers::process::sys_getpriority(args),
        141 => handlers::process::sys_setpriority(args),
        ...
        128 => handlers::signal::sys_rt_sigtimedwait(args),
        ...
        98 => handlers::time::sys_getrusage(args),
        ...
        237 => handlers::process::sys_mbind(args),
        238 => handlers::process::sys_set_mempolicy(args),
        239 => handlers::process::sys_get_mempolicy(args),
        63 => handlers::process::sys_uname(args),
        218 => handlers::process::sys_set_tid_address(args),
        302 => handlers::time::sys_prlimit64(args),
        309 => handlers::thread::sys_getcpu(args),
        24 => handlers::thread::sys_sched_yield(args),
        202 => handlers::thread::sys_futex(args),
        203 => handlers::thread::sys_sched_setaffinity(args),
        204 => handlers::thread::sys_sched_getaffinity(args),
        206 => handlers::io::sys_io_setup(args),
