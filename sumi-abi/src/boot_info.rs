...
///   3: num_cpus (multithreading phase 1).
#[repr(C)]
#[derive(Clone, Copy)]
pub struct BootInfo {
    ...
    // v3 fields
    /// Total number of vCPUs created by the host. Informational for
    /// Phase 1 (APs self-initialize); read by the scheduler in Phase 3.
    /// Always in 1..=MAX_VCPUS.
